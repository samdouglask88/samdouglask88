...
![Status](https://img.shields.io/badge/Status-Desenvolvedor_Júnior-1a4a6b?style=for-the-badge&labelColor=0a0f1e)
...
**Ultrassitech Sistemas** · Efetivo · *Jul/2026 – momento*
📍 Salvador, Bahia, Brasil · Presencial

Promovido após o estágio, seguindo no desenvolvimento e manutenção de sistemas, com atuação mais ampla em backend, integrações e infraestrutura.

- ⚡ Desenvolvimento de funcionalidades com **TypeScript**, **NestJS** e **Next.js**
- 🗄️ Modelagem e integração com **PostgreSQL**, **MySQL** e **MongoDB** via **Prisma ORM**
- 🔌 Integração de hardware e protocolos em tempo real (**WebSocket**, filas com **Redis**)
- 🚀 Estruturação de pipelines de deploy com **Docker**, **GitHub Actions** e **Nginx**
- ☁️ Uso de serviços **AWS** (SES, S3) para e-mail transacional e backup automatizado
- ✅ Escrita de testes automatizados (**Jest**, Testing Library)
- 🐛 Debug e correção de bugs de causa raiz em sistemas em produção

### 🏢 Estagiário de Desenvolvimento
**Ultrassitech Sistemas** · Estágio · *Mai/2026 – Jul/2026*
📍 Salvador, Bahia, Brasil · Presencial
...
**✅ Conquistado**
- Promovido de estagiário para Desenvolvedor Júnior
...
- Segurança em APIs
- Integração com WebSocket, filas (Redis) e serviços AWS
